...
slope, intercept, r_value, p_value, std_err = sp.stats.linregress([row[0] for row in dataYellow[:5]], [(row[1] ** 0.5) for row in dataYellow[:5]])
...
slope, intercept, r_value, p_value, std_err = sp.stats.linregress([row[0] for row in dataGreen[:8]], [(row[1] ** 0.5) for row in dataGreen[:8]])
...
slope, intercept, r_value, p_value, std_err = sp.stats.linregress([row[0] for row in dataRed[:5]], [(row[1] ** 0.5) for row in dataRed[:5]])
...
slope, intercept, r_value, p_value, std_err = sp.stats.linregress([row[0] for row in dataViolet[:11]], [(row[1] ** 0.5) for row in dataViolet[:11]])
...
plt.plot([f_Yellow, f_Green, f_Red, f_Violet], [-U_Yellow.n, -U_Green.n, -U_Red.n, -U_Violet.n], 'x', label='Messdaten', color ='black')
